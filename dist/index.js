...
const PAD_VIEW = { x: 100, y: 103, w: 700, h: 397 };
...
const cellByIndex = (i) => PAD_CELLS[i];
...
const RegionPanel = ({ region, ledColor, children }) => {
    ...
    return (SP_JSX.jsxs(SP_JSX.Fragment, { children: [lit ? (SP_JSX.jsx("div", { className: "dt-glow", style: Object.assign({
                    position: "absolute",
                    ...
                    filter: "blur(" + blur + "px)",
                }, ledColor?.kind === "flash" ? flashStyle(ledColor) : {}) })) : null, children] }));
};
const PadCell = ({ slot, occupant, armed, isSource, onActivate, ledColor, cellRef }) => {
    ...
    return (SP_JSX.jsxs(DFL.Focusable, { ref: cellRef, onActivate: onActivate, focusClassName: "dt-pad-focus", className: "dt-cell", style: {
            ...
            ...(animated ? flashBrightnessStyle(ledColor) : {}),
                ...
                }, children: slot.label })), occupant && occupant.build > 1 ? (SP_JSX.jsx("div", { style: {
...
const PadGrid = ({ slots, pads, held, moveSource, onSlot, padColors, gridRef }) => {
    ...
    const cell = (i) => {
        ...
        if (!s)
            return null;
        return (SP_JSX.jsx(PadCell, { slot: s, occupant: pads[i], armed: held !== null && !pads[i], isSource: moveSource === i, onActivate: () => onSlot(i), ledColor: zoneLed(s.zone), cellRef: i === ZONE_ORDER.left[0] ? gridRef : undefined }, i));
    };
    ...
    return (SP_JSX.jsxs(SP_JSX.Fragment, { children: [SP_JSX.jsx("style", { children: flashKeyframes(activeLeds) }), SP_JSX.jsxs("div", { ref: ledRootRef, style: {
                    position: "relative",
                    width: "100%",
                ...
                }, children: [SP_JSX.jsx(RegionPanel, { region: "left", ledColor: zoneLed("left") }), SP_JSX.jsx(RegionPanel, { region: "centre", ledColor: zoneLed("centre") }), SP_JSX.jsx(RegionPanel, { region: "right", ledColor: zoneLed("right") }), SP_JSX.jsxs(DFL.Focusable, { "flow-children": "grid", style: { position: "absolute", inset: 0 }, children: [ZONE_ORDER.left.map(cell), ZONE_ORDER.centre.map(cell), ZONE_ORDER.right.map(cell)] })] })] }));
};
...
const BACKEND_SHORT_NAMES = { rpcs3: "RPCS3", xenia: "Xenia" };
const backendShortName = (key) => BACKEND_SHORT_NAMES[key] || (key ? key.toUpperCase() : "the backend");
...
const Content = () => {
    ...
    const [gmPlayChecked, setGmPlayChecked] = SP_REACT.useState(true);
    const [desktopGuiChecked, setDesktopGuiChecked] = SP_REACT.useState(false);
    const [desktopPlayChecked, setDesktopPlayChecked] = SP_REACT.useState(false);
    ...
    if (view === "setup") {
        return (SP_JSX.jsx(SP_JSX.Fragment, { children: SP_JSX.jsxs(DFL.Focusable, { ref: setupRef, autoFocus: true, onCancel: () => setView("pad"), "flow-children": "vertical", children: [SP_JSX.jsx(HotkeySection, {}), SP_JSX.jsx(DiagnosticsSection, {}), SP_JSX.jsxs(DFL.PanelSection, { title: "Setup", children: [SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.ButtonItem, { layout: "below", onClick: () => setView("pad"), children: "Back to pad" }) }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.ButtonItem, { layout: "below", disabled: working !== "", onClick: async () => {
                                        ...
                                        await refresh();
                                    }, children: `Pad Skin: ${setup?.padSkin || "default"} (Click to cycle)` }) }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.ToggleField, { label: "Sound Effects", checked: setup?.soundEffects !== false, onChange: async (val) => {
                                        ...
                                        notify(res);
                                        await refresh();
                                    }, children: ["Install patched RPCS3 (", release.sizeMB, " MB)"] }) })) : null, SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.TextField, { label: "RPCS3 bundled AppImage (authoritative)", value: setup?.rpcs3Path ?? "", disabled: true }) })] }), SP_JSX.jsxs(DFL.PanelSection, { title: "Play", children: [SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.ToggleField, { label: "Game Mode \u2014 play", description: "Boots straight into the game, no GUI. Added to Steam's library.", checked: gmPlayChecked, onChange: setGmPlayChecked }) }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.ToggleField, { label: "Desktop \u2014 emulator GUI", description: "Opens the emulator's own settings screens, no game.", checked: desktopGuiChecked, onChange: setDesktopGuiChecked }) }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.ToggleField, { label: "Desktop \u2014 play", description: "Same script as Game Mode play, for testing outside Game Mode.", checked: desktopPlayChecked, onChange: setDesktopPlayChecked }) }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx("div", { style: { fontSize: "10px", opacity: 0.6, lineHeight: 1.4, padding: "2px 0" }, children: (setup?.backend || "rpcs3") === "xenia"
                                        ? "Xenia's GUI is controller-navigable: Display → Internal Resolution, Display → Toggle 60 FPS Unlock, Performance on Right Shift."
                                        : "RPCS3's Qt UI is mouse-oriented — the GUI shortcut may need a mouse or trackpad, not just a stick." }) }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.ButtonItem, { layout: "below", disabled: !gmPlayChecked && !desktopGuiChecked && !desktopPlayChecked, onClick: async () => {
                                    ...
                                    }, children: "Create shortcuts" }) }), shortcutMsg ? (SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx("div", { style: { fontSize: "11px", opacity: 0.75, lineHeight: 1.4 }, children: shortcutMsg }) })) : null] }), SP_JSX.jsx(DFL.PanelSection, { title: "After setup", children: SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx("div", { style: { fontSize: "11px", opacity: 0.7, lineHeight: 1.5 }, children: "Use Create shortcuts above. Launch LEGO Dimensions from Steam; the Game Mode shortcut boots straight into the game. The emulator's own settings remain available via the Desktop \u2014 emulator GUI shortcut." }) }) }), SP_JSX.jsxs(DFL.PanelSection, { title: "Reset", children: [SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.ButtonItem, { layout: "below", onClick: async () => {
    ...
    return (SP_JSX.jsx(SP_JSX.Fragment, { children: SP_JSX.jsxs(DFL.PanelSection, { title: "LEGO Dimensions Toypad", children: [SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsxs("div", { style: { fontSize: "12px", lineHeight: 1.45 }, children: [SP_JSX.jsx("div", { style: { fontWeight: 600 }, children: listening === false ? "Toypad listener not connected" : "Toypad overlay ready" }), SP_JSX.jsx("div", { style: { fontSize: "10px", opacity: 0.6, marginTop: "3px" }, children: "The Toypad, picker, LEDs and controller navigation live in one overlay." })] }) }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.ButtonItem, { layout: "below", onClick: () => openToypadModal(), children: "Open Toypad overlay" }) }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.ButtonItem, { layout: "below", onClick: () => { refreshSetup(); refreshRelease(); setView("setup"); }, children: "Setup & phone remote" }) })] }) }));
};
...
const LedDiagnostics = ({ data }) => {
    ...
    const line = (e, i) => {
        ...
        return (SP_JSX.jsxs("div", { style: { padding: "6px 0", borderTop: "1px solid rgba(255,255,255,.08)", fontSize: "10px" }, children: [SP_JSX.jsxs("div", { style: { display: "flex", justifyContent: "space-between", opacity: .75 }, children: [SP_JSX.jsxs("span", { children: [stamp, " \u00B7 seq ", String(e?.seq ?? "—"), " \u00B7 serial ", String(e?.serial ?? "—"), " (", delta, ")"] }), SP_JSX.jsx("span", { children: e?.source || "GET_LED snapshot" })] }), SP_JSX.jsx("div", { style: { display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "4px", marginTop: "4px" }, children: ["0", "1", "2"].map((key) => {
                ...
                zIndex: 99999,
                    ...
                    boxShadow: "0 24px 60px rgba(0,0,0,.6)",
                            ...
                            SP_JSX.jsx(DFL.Focusable, { "flow-children": "grid", style: {
                                    ...
                                    : SP_JSX.jsx("div", { style: { fontSize: "11px", opacity: 0.5, padding: "8px 2px" }, children: "Nothing in this franchise." }) }))] })) : (SP_JSX.jsxs(SP_JSX.Fragment, { children: [SP_JSX.jsx(DFL.Focusable, { onActivate: async () => {
                                    const next = !ledOn;
                                    setLedOn(next);
                                    await setLedEnabled(next).catch(() => { });
                                    refreshState();
                                    refreshLeds();
                                }, focusClassName: "dt-pad-focus", style: { marginTop: "10px", padding: "8px", borderRadius: "8px", textAlign: "center", background: "rgba(20,24,33,.6)", border: "1px solid " + (ledOn ? "#45b8ff" : "transparent"), fontSize: "12px" }, children: ledOn ? "LED lighting: on" : "LED lighting: off (Toypad still works)" }), SP_JSX.jsx(DFL.Focusable, { onActivate: () => setLedDiagOpen((v) => !v), focusClassName: "dt-pad-focus", style: { marginTop: "10px", padding: "8px", borderRadius: "8px", textAlign: "center", background: "rgba(20,24,33,.6)", border: "1px solid " + (ledDiagOpen ? "#45b8ff" : "transparent"), fontSize: "12px" }, children: ledDiagOpen ? "Hide LED diagnostics" : "Show LED diagnostics" }), ledDiagOpen ? SP_JSX.jsx(LedDiagnostics, { data: ledDiag }) : null, SP_JSX.jsxs(DFL.Focusable, { "flow-children": "horizontal", style: { display: "flex", gap: "6px", marginTop: "10px" }, children: [btn(demoMode ? "LED demo: running" : "LED demo mode", () => setDemoMode(!demoMode), demoMode ? "on" : undefined), btn(mode === "move" ? "Moving..." : "Move", () => { setMoveSource(null); setMode(mode === "move" ? "pad" : "move"); }, mode === "move" ? "on" : ""), btn(mode === "remove" ? "Removing..." : "Remove", () => setMode(mode === "remove" ? "pad" : "remove"), mode === "remove" ? "on" : ""), btn("Clear all", async () => { setBusy("Clearing..."); await clearAll().catch(() => { }); setBusy(""); refreshState(); refreshLeds(); }), btn("Close", () => shut())] })] }))] }) }) }));
};
let modalOpen = false;
...
const DiagnosticsSection = () => {
    ...
    return (SP_JSX.jsxs(DFL.PanelSection, { title: "Diagnostics", children: [SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.ToggleField, { label: "LED diagnostics", checked: on, onChange: async (v) => { setOn(v); await setDiagnosticsEnabled(v).catch(() => { }); } }) }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx("div", { style: { fontSize: "11px", opacity: 0.6, padding: "2px 0" }, children: "Records the GET_LED history and raw hex for troubleshooting. The Toypad still receives every colour with this off - only the recording stops." }) })] }));
};
const HotkeySection = () => {
    ...
    return (SP_JSX.jsxs(DFL.PanelSection, { title: "Hotkey", children: [SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx("div", { style: { fontSize: "11px", opacity: 0.65, padding: "2px 0" }, children: "Summon the toypad over a running game. Press it again to close." }) }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.ToggleField, { label: "Hotkey enabled", checked: !!st.enabled, onChange: async (v) => { await hotkeySet(st.chord || [], v).catch(() => { }); setSt(await hotkeyState().catch(() => st)); } }) }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx("div", { style: { fontSize: "11px", opacity: 0.8, padding: "2px 0" }, children: capturing ? ("Release all buttons, then hold the exact chord... " + ((diag.held || []).map(keyLabel).join(" + ") || "(waiting)"))
                        : ("Current chord: " + describe()) }) }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.ButtonItem, { layout: "below", onClick: () => { if (capturing) {
                        cancelCapture();
                        setCapturing(false);
                    }
                    else {
                        beginCapture();
                    } }, children: capturing ? "Listening... (tap to cancel)" : "Set hotkey chord" }) }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.ButtonItem, { layout: "below", onClick: async () => { await hotkeySet([], false).catch(() => { }); setSt(await hotkeyState().catch(() => st)); }, children: "Clear hotkey" }) }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.ButtonItem, { layout: "below", onClick: () => overlayBus.emit("toggle"), children: "Open toypad overlay" }) }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx("div", { style: { fontSize: "10px", opacity: 0.75, padding: "4px 0", lineHeight: 1.35 }, children: (diag.events > 0)
                        ? null
                        : (diag.nodes ? "Steam holds the controller, so button presses never reach the plugin. Bind a key instead: Steam → Controller Settings → edit layout → put a keyboard key (F13 works well) on a back button, then capture it here."
                            : "No input devices could be opened. Restart Decky so the backend reloads.") }) }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx("div", { style: { fontSize: "9px", opacity: 0.55, fontFamily: "monospace", wordBreak: "break-all", padding: "3px 0" }, children: "evdev " + (diag.attached ? "OK" : "DOWN") + " · nodes " + (diag.nodes || 0) + " · key events " + diag.events +
                        (diag.error ? (" · ERR " + diag.error) : "") }) }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx("div", { style: { fontSize: "9px", opacity: 0.45, fontFamily: "monospace", wordBreak: "break-all" }, children: (diag.devices && diag.devices.length)
